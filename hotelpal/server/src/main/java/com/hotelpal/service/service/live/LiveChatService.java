...
//			env.pool.submit(new MessageWorker(courseId, i));
//			env.locks[i] = new ReentrantLock();
//		}
...
//		MessageWorker(Integer courseId, Integer tId) {
...
//				try {
////					courseEnvMap.get(courseId).locks[threadId].lock();
...
//				}
////				finally {
////					courseEnvMap.get(courseId).locks[threadId].unlock();
////				}
//			}
//		}
//	}
...
////		ExecutorService pool = new ThreadPoolExecutor(2, 2000, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
//		ExecutorService pool = Executors.newFixedThreadPool(POOL_SIZE);
//		Lock[] locks = new ReentrantLock[POOL_SIZE];
